...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 818.0, 418.0, 181.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 566.0, 531.0, 164.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 497.0, 531.0, 59.0, 22.0 ],
					"text" : "mute 1, 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 823.0, 456.0, 58.0, 22.0 ],
					"text" : "r mute.all"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 754.0, 516.0, 56.0, 22.0 ],
					"text" : "thispoly~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 754.0, 418.0, 59.0, 22.0 ],
					"text" : "mute 0, 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 390.833333333333371, 589.0, 150.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 348.0, 589.0, 35.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 304.0, 589.0, 35.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 151.0, 589.0, 42.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 151.0, 43.0, 28.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 193.333333333333371, 589.0, 105.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "<function>\nOur familiar ADSR (attack  decay sustain release) curve\n\nNotice that there is NO SUSTAIN turned on..."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 187.0, 43.0, 150.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 431.333333333333371, 463.0, 84.666666666666629, 22.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 151.0, 401.0, 71.0, 22.0 ],
					"text" : "t f b b"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-18", 0 ],
					"midpoints" : [ 186.5, 430.0, 357.0, 430.0, 357.0, 348.0, 380.5, 348.0 ],
					"source" : [ "obj-16", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 212.5, 495.0, 741.0, 495.0, 741.0, 414.0, 763.5, 414.0 ],
					"source" : [ "obj-16", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-23", 0 ],
					"midpoints" : [ 506.5, 576.0, 741.0, 576.0, 741.0, 510.0, 763.5, 510.0 ],
					"source" : [ "obj-26", 0 ]
				}
